...
public class Pedidos {
    ...
    private Date _fecha_pedido;
    private String _direccion_entrega;
    private Double _precio_total;
    private int _idEmpleados, _idClientes;

    public Pedidos(String pIdPedidos, Date pFecha_Pedido, String pDireccion_Entrega, Double pPrecio_Total, int pEmpleados, int pClientes) {
    ...
    public void setFecha_Pedido(Date value){
