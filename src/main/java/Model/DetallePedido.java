...
public class DetallePedido {
    ...
    public DetallePedido(String pIdDetallePedido, int pCantidad, Double pPrecio, String pPedidos, String pProducto) {
    ...
    public String get_pedidos(){
        return _pedidos;
    }
    public void set_pedidos(String value){
        this._pedidos=value;
    }
    public String get_producto(){
        return _producto;
    }
    public void set_producto(String value){
